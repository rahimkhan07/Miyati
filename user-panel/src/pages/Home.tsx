                ...
                {featuredProducts.map((product, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="group relative bg-[#f7f7f7] border border-gray-200 rounded-3xl p-18 transition-all duration-300 hover:shadow-xl overflow-hidden"
                    >
                      {/* HOVER ICONS */}
...
>
  ...
  className="relative text-center group cursor-pointer
             rounded-[30vh] border-dashed p-2 sm:p-6
             border border-transparent
             transition-all duration-1000
             hover:scale-10 hover:border-[#4b97c9] border-[3px]"
